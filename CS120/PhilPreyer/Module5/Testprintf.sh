#! /bin/bash
printf "Two tabs after ne\t\tA new line after me\nThe hexadeciman digits X42 represents \x42\n"
...
printf "%s#%02x%02x%02x\n" "%x prints in hexadecimal. Here is an example to convert a RGB color 82 185 255 to a hex notation: " \ 82 185 255
