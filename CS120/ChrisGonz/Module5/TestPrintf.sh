#! /bin/bash
printf "Two tabs after me\t\tA new line after me\nThe hexadecimal X42 represents \x42\n"

printf "%s\n" "Print in one line"
printf "%b\n" "%b tells printf to escape sequences. Two tabs after me\t\t."
printf "%s%d\n%s%f\n%s%e\n" "%d prints integers such as:" 25.5 " %f prints float numbers such as : "25.5 \ "%e prints with the exceptional notation sych as : " 25.5
