...
printf "%s#%02x%02x%02x\n" "%x prints in hexidecimal. Here is an example to convert a RGB color 82 185 225 to a hex notation: " \ 82 185 255
...
printf "==============================================================\n"
printf "$format" 1 "Joram Howard" 234.30 2 "Arthur B" 332.23 3 "Evan A" 525.32
